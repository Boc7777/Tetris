...
Block_L::Block_L(float _cell_size, Color _color, RenderWindow* _window, vector<TetrisBlock*> _blocks_tab) {
...
RenderWindow* Block_L::getWindow() {
	return window;
}

vector<TetrisBlock*> Block_L::getTabBloks() {
	return blocks_tab;
}

vector<Cell>& Block_L::getTabCells() {
	return mini_cells_tab;
}

float Block_L::getCellSize() {
	return cell_size;
}

void Block_L::setBlockUnderControl(bool _bool) {
	block_under_control = _bool;
}

Color Block_L::getColor() {
	return color;
}

Vector2f& Block_L::GetBlockPosition() {
	return blockPosition;
}

void Block_L::setBlockPosition(Vector2f position) {
